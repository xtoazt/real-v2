    ...
    <Box className="Home">
      ...
      >
        <Typography variant="body1">
          Welcome to Real V2. All data is secure, not collected, and anonymous.
        </Typography>
      </Box>
      <Box
        sx={{
      ...
      >
        <MuiLink
          href="https://github.com/xtoazt/real-v2"
          target="_blank"
          sx={() => ({
      ...
      <Typography variant="body1" sx={{ textAlign: 'center', mb: 1 }}>
        Licensed under{' '}
        <MuiLink
          href="https://github.com/xtoazt/real-v2/blob/develop/LICENSE"
          target="_blank"
        >
          GPL v2
        </MuiLink>
        . Please{' '}
        <MuiLink
          href="https://github.com/xtoazt/real-v2/blob/develop/README.md"
          target="_blank"
        >
          read the docs
        </MuiLink>
